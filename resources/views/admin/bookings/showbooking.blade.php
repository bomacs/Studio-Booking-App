                            ...
                            <div class="flex flex-col space-y-6 text-sm text-veryDarkBlue w-full md:w-1/2">
                                <div>
                                    <div class="flex flex-col justify-between mt-2 md:flex-row">
                                        <div class="w-full">
                                            <x-input-label for="booking_id" class="px-2 py-2 font-semibold" :value="__('Payment ID')" />
                                        </div>
                                        <div class="w-full">       
                                            <x-text-input id="booking_id" class="block w-full py-2 text-darkGrayishBlue hover:text-darkBlue cursor-pointer" type="text" name="booking_id" value="{{$booking->id}}"  disabled />
                                        </div>
                                    </div>
                                </div>
                                <div>
                                ...
                                <div>
                                    <div>
                                        <div class="flex flex-col justify-between mt-2 md:flex-row">
                                            ...
                                            <div class="w-full">
                                                <a href="{{ route('payment.show', $booking->payment->id) }}">
                                                <x-text-input id="payment_id" class="block w-full py-2 text-darkGrayishBlue hover:text-darkBlue cursor-pointer" type="text" name="payment_id" value="{{$booking->payment->id}}"  disabled />
                                                </a>
                                            </div>
                                        </div>
                                    </div>
